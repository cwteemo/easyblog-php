...
class Baksql
{
    ...
    public function __construct($config) {
        $database_bak_path = DATA_PATH . 'database/'; //默认目录
        if (!is_dir($database_bak_path)) {
            mkdir($database_bak_path, 0777, true);
        }
        $config['path'] = $database_bak_path;
...
//            }
    ...
    private function writeToFile($tables = array(), $ddl = array(), $data = array())
    {
        ...
        $str .= "Data:" . date('Y-m-d H:1:s', time()) . "\r\n*/\r\n";
